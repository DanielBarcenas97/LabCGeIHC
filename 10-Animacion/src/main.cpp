...
void applicationLoop() {
	...
	while (psi) {
		...
		shaderMulLighting.setInt("pointLightCount", 5);   //Multiple Light .fs
		//Posicion de la luz con indice 0
		shaderMulLighting.setVectorFloat3("pointLights[0].position", glm::value_ptr((glm::vec3(-5.1, 4.5, -3.5))));  //  position de la luz
		//Propiedad de la luz  verde
		...
		shaderMulLighting.setFloat("pointLights[0].constant", 1.0); //Casi siempre a 1
		...
		//////LUZ nueva 2
		shaderMulLighting.setVectorFloat3("pointLights[4].position", glm::value_ptr((glm::vec3(-14.9, 4.8, -3.8))));
		...
		sphereLamp.setScale(glm::vec3(0.1, 0.1, 0.2));
		sphereLamp.setPosition(glm::vec3(-14.9, 4.8, -3.8));
